    ...
    <div className="bg-white relative">
      <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
        ...
        <div className="flex-1">
          <p className="font-mono text-black text-[10px] sm:text-xs font-bold mb-1">REPUBLIC OF BULGARIA</p>
          <p className="font-mono text-black text-[10px] sm:text-xs">IDENTITY CARD</p>
        </div>
      </div>
